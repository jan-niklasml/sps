<template>
    <v-dialog :key="props.value" v-model="visible" persistent width="800">
        ...
        <v-card>
            ...
            <v-card-actions>
                <v-spacer />
                <v-btn id="yesnodialog-btn-no" text @click="no"> Nein </v-btn>
                <v-btn id="yesnodialog-btn-yes" color="primary" @click="yes">
                    Ja
                </v-btn>
            </v-card-actions>
        </v-card>
