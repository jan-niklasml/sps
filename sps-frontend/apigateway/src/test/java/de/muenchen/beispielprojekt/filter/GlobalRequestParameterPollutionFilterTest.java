 ...
 */
package de.muenchen.beispielprojekt.filter;

import de.muenchen.beispielprojekt.ApiGatewayApplication;
...
class GlobalRequestParameterPollutionFilterTest {
    ...
    void parameterPollutionAttack() {
        ...
        webTestClient.get().uri("/api/beispielprojekt-backend-service/testendpoint?parameter1=testdata_1&parameter2=testdata&parameter1=testdata_2").exchange()
                .expectStatus()
