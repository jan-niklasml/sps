...
import de.muenchen.beispielprojekt.domain.TheEntity;
...
@PreAuthorize("hasAuthority(T(de.muenchen.beispielprojekt.security.AuthoritiesEnum).BEISPIELPROJEKT_BACKEND_READ_THEENTITY.name())")
public interface TheEntityRepository
        extends PagingAndSortingRepository<TheEntity, UUID>, CrudRepository<TheEntity, UUID> { // NOSONAR
     ...
     *
     * <p>
     * If the id already exists, the {@link TheEntity} will be overridden, hence update. If the
     * id does not already exist, a new {@link TheEntity} will be created, hence create.
     *
    ...
    @PreAuthorize("hasAuthority(T(de.muenchen.beispielprojekt.security.AuthoritiesEnum).BEISPIELPROJEKT_BACKEND_WRITE_THEENTITY.name())")
     ...
     *
     * <p>
     * If the id already exists, the {@link TheEntity}s will be overridden, hence update. If the
     * id does not already exist, the new {@link TheEntity}s will be created, hence create.
     *
    ...
    @PreAuthorize("hasAuthority(T(de.muenchen.beispielprojekt.security.AuthoritiesEnum).BEISPIELPROJEKT_BACKEND_DELETE_THEENTITY.name())")
