...
import de.muenchen.beispielprojekt.configuration.nfcconverter.NfcRequestFilter;
 ...
 *
 * <ul>
 * <li>Es werden alle Requests gefiltert, die an URIs unter <em>/*</em> geschickt werden.
 * <li>Filter ist in Bean <em>nfcRequestFilter</em> enthalten.
 * <li>Es werden nur Requests mit den Content-Types <em>text/plain</em>; <em>application/json</em>
 * und <em>text/html</em> gefiltert.
 * </ul>
 */
@Configuration
