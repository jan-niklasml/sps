 ...
 */
package de.muenchen.beispielprojekt.configuration;

import static de.muenchen.beispielprojekt.TestConstants.SPRING_NO_SECURITY_PROFILE;
import static de.muenchen.beispielprojekt.TestConstants.SPRING_TEST_PROFILE;
import static de.muenchen.beispielprojekt.TestConstants.TheEntityDto;
import static org.junit.jupiter.api.Assertions.assertEquals;

import de.muenchen.beispielprojekt.MicroServiceApplication;
import de.muenchen.beispielprojekt.domain.TheEntity;
import de.muenchen.beispielprojekt.rest.TheEntityRepository;
import java.net.URI;
...
@SpringBootTest(classes = { MicroServiceApplication.class }, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT, properties = {
...
class UnicodeConfigurationTest {
    ...
    void testForNfcNormalization() {
        ...
        final TheEntityDto response = testRestTemplate
                .postForEntity(
                        URI.create(ENTITY_ENDPOINT_URL), theEntityDto, TheEntityDto.class)
                .getBody();
        ...
        final UUID uuid = UUID.fromString(
                StringUtils.substringAfterLast(
                        response.getRequiredLink("self").getHref(), "/"));
